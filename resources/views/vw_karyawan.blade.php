...
<body>
    ...
    <tbody>
      @foreach ($result->Karyawan as $output)
        <tr>
          ...
          <td class="border-solid border-2 border-green-500 bg-transparent text-center px-2.5">{{ $output->nama_karyawan }}</td>
  ...
  <script>
    ...
    const goToAdd = () => {
        // direct link
      location.href='{{ url("/add") }}'; // jika ada petik 2 jangan lagi menggunakan maka akan tertutup
      // window.open();
    }
